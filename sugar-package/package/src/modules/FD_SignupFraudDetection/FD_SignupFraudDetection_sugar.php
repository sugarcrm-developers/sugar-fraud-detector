 ...
 * PLACE ANY CUSTOMIZATIONS IN FD_SignupFraudDetection
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class FD_SignupFraudDetection_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'FD_SignupFraudDetection';
    public $object_name = 'FD_SignupFraudDetection';
    public $table_name = 'fd_signupfrauddetection';
